...
CREATE TABLE IF NOT EXISTS `Lifetime` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Issue_Date` DATETIME(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Contracts` (
  ...
  `Last_Statisfied_Time` DATETIME(45) NULL,
  PRIMARY KEY (`ID`),
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (1, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (2, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (3, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (4, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (5, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (6, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (7, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (8, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (9, '2012-01-01', '2015-01-01', NULL, 1);
INSERT INTO `Lifetime` (`ID`, `Issue_Date`, `Creation_Date`, `Termination_Date`, `Is_Active`) VALUES (10, '2012-01-01', '2015-01-01', NULL, 1);
